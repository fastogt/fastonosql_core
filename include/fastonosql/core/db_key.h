...
inline bool operator==(const NKey &r, const NKey &l) { return r.Equals(l); }

inline bool operator!=(const NKey &r, const NKey &l) { return !(r == l); }
...
public:
  ...
  template <typename U> explicit NValue(U *u) : base_class(u) {}
