...
// path is file
class DBConnection
    : public core::internal::CDBConnection<NativeConnection, Config, FORESTDB> {
public:
  typedef core::internal::CDBConnection<NativeConnection, Config, FORESTDB>
      base_class;
...
private:
  common::Error CheckResultCommand(const std::string &cmd,
                                   fdb_status err) WARN_UNUSED_RESULT;
