...
class DBConnection
    : public core::internal::CDBConnection<NativeConnection, Config, ROCKSDB> {
public:
  typedef core::internal::CDBConnection<NativeConnection, Config, ROCKSDB>
      base_class;
  ...
  common::Error Mget(const std::vector<std::string> &keys,
                     std::vector<std::string> *ret);
  common::Error Merge(const std::string &key,
                      const std::string &value) WARN_UNUSED_RESULT;

private:
  common::Error
  CheckResultCommand(const std::string &cmd,
                     const ::rocksdb::Status &err) WARN_UNUSED_RESULT;
