...
public:
  ...
  common::Error GraphQuery(const commands_args_t &argv,
                           FastoObject *out) WARN_UNUSED_RESULT;
  common::Error GraphExplain(const commands_args_t &argv,
                             FastoObject *out) WARN_UNUSED_RESULT;
  common::Error GraphDelete(const commands_args_t &argv,
                            FastoObject *out) WARN_UNUSED_RESULT;

  common::Error JsonSet(const NDbKValue &key,
                        NDbKValue *added_key) WARN_UNUSED_RESULT;
  common::Error JsonGet(const NKey &key,
                        NDbKValue *loaded_key) WARN_UNUSED_RESULT;

  // stream
  common::Error XAdd(const NDbKValue &key, NDbKValue *added_key,
                     std::string *gen_id) WARN_UNUSED_RESULT;
  common::Error XRange(const NKey &key, NDbKValue *loaded_key,
                       FastoObject *out) WARN_UNUSED_RESULT;
  ...
  common::Error
  ModuleUnLoad(const ModuleInfo &module) WARN_UNUSED_RESULT; // nvi
#endif
private:
  ...
  common::Error XAddImpl(const NDbKValue &key, NDbKValue *added_key,
                         std::string *gen_id);
  common::Error XRangeImpl(const NKey &key, NDbKValue *loaded_key,
                           FastoObject *out);
