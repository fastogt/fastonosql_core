...
#include <fastonosql/core/db/leveldb/comparators/indexed_db/indexed_db_key.h>
...
bool DecodeByte(common::StringPiece *slice,
                unsigned char *value) WARN_UNUSED_RESULT;
...
bool DecodeVarInt(common::StringPiece *slice,
                  int64_t *value) WARN_UNUSED_RESULT;
bool DecodeString(common::StringPiece *slice,
                  common::string16 *value) WARN_UNUSED_RESULT;
bool DecodeStringWithLength(common::StringPiece *slice,
                            common::string16 *value) WARN_UNUSED_RESULT;
bool DecodeBinary(common::StringPiece *slice,
                  std::string *value) WARN_UNUSED_RESULT;
bool DecodeDouble(common::StringPiece *slice, double *value) WARN_UNUSED_RESULT;
bool DecodeIDBKey(common::StringPiece *slice,
                  std::unique_ptr<IndexedDBKey> *value) WARN_UNUSED_RESULT;
// bool DecodeIDBKeyPath(common::StringPiece* slice, IndexedDBKeyPath* value)
// WARN_UNUSED_RESULT;
bool DecodeBlobJournal(common::StringPiece *slice,
                       BlobJournalType *journal) WARN_UNUSED_RESULT;
int CompareEncodedStringsWithLength(common::StringPiece *slice1,
                                    common::StringPiece *slice2, bool *ok);
bool ExtractEncodedIDBKey(common::StringPiece *slice,
                          std::string *result) WARN_UNUSED_RESULT;
int CompareEncodedIDBKeys(common::StringPiece *slice1,
                          common::StringPiece *slice2, bool *ok);
...
int CompareIndexKeys(const common::StringPiece &a,
                     const common::StringPiece &b);
class KeyPrefix {
public:
...
private:
  ...
  KeyPrefix(enum Type, int64_t database_id, int64_t object_store_id,
            int64_t index_id);
...
public:
  ...
  static std::string Encode(const std::string &origin_identifier,
                            const common::string16 &database_name);
  static std::string
  EncodeMinKeyForOrigin(const std::string &origin_identifier);
  static std::string
  EncodeStopKeyForOrigin(const std::string &origin_identifier);
...
public:
  ...
  static bool Decode(common::StringPiece *slice,
...
public:
  ...
  static std::string Encode(int64_t database_id, int64_t object_store_id,
                            int64_t index_id, unsigned char meta_data_type);
  static std::string EncodeMaxKey(int64_t database_id, int64_t object_store_id);
  static std::string EncodeMaxKey(int64_t database_id, int64_t object_store_id,
                                  int64_t index_id);
...
public:
  ...
  static bool FromObjectStoreDataKey(common::StringPiece *slice,
                                     BlobEntryKey *result);
...
public:
  ...
  static std::string EncodeMinKey(int64_t database_id, int64_t object_store_id,
                                  int64_t index_id);
  static std::string EncodeMaxKey(int64_t database_id, int64_t object_store_id,
                                  int64_t index_id);
  int64_t DatabaseId() const;
