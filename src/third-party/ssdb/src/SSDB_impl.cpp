...
inline static Status _read_list(const std::vector<std::string> *resp,
...
inline static Status _read_int64(const std::vector<std::string> *resp,
                                 int64_t *ret) {
  Status s(resp);
  if (s.ok()) {
    if (resp->size() >= 2) {
...
inline static Status _read_str(const std::vector<std::string> *resp,
                               std::string *ret) {
  Status s(resp);
  if (s.ok()) {
    if (resp->size() >= 2) {
...
ClientImpl::ClientImpl() { link = NULL; }
...
ClientImpl::request(const std::vector<std::string> &req) {
  if (link->send(req) == -1) {
    return NULL;
  }
  if (link->flush() == -1) {
  ...
  resp_.clear();
  for (std::vector<Bytes>::const_iterator it = packet->begin();
       it != packet->end(); it++) {
    const Bytes &b = *it;
...
const std::vector<std::string> *
ClientImpl::request(const std::string &cmd, const std::string &s2,
...
const std::vector<std::string> *
ClientImpl::request(const std::string &cmd,
                    const std::vector<std::string> &s2) {
  std::vector<std::string> req;
  req.push_back(cmd);
  for (std::vector<std::string>::const_iterator it = s2.begin(); it != s2.end();
       ++it) {
    req.push_back(*it);
  }
  return request(req);
...
ClientImpl::request(const std::string &cmd, const std::string &s2,
  ...
  req.push_back(cmd);
  req.push_back(s2);
  for (std::vector<std::string>::const_iterator it = s3.begin(); it != s3.end();
       ++it) {
    req.push_back(*it);
  }
  return request(req);
...
Status ClientImpl::set_kv_range(const std::string &start,
...
Status ClientImpl::setx(const std::string &key, const std::string &val,
                        int ttl) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::keys(const std::string &key_start,
...
Status ClientImpl::scan(const std::string &key_start,
                        const std::string &key_end, uint64_t limit,
                        std::vector<std::string> *ret) {
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::rscan(const std::string &key_start,
                         const std::string &key_end, uint64_t limit,
                         std::vector<std::string> *ret) {
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::multi_get(const std::vector<std::string> &keys,
                             std::vector<std::string> *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::hget(const std::string &name, const std::string &key,
                        std::string *val) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::hset(const std::string &name, const std::string &key,
...
Status ClientImpl::hincr(const std::string &name, const std::string &key,
...
Status ClientImpl::hkeys(const std::string &name, const std::string &key_start,
                         const std::string &key_end, uint64_t limit,
                         std::vector<std::string> *ret) {
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::hscan(const std::string &name, const std::string &key_start,
                         const std::string &key_end, uint64_t limit,
                         std::vector<std::string> *ret) {
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::hrscan(const std::string &name, const std::string &key_start,
                          const std::string &key_end, uint64_t limit,
                          std::vector<std::string> *ret) {
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::multi_hget(const std::string &name,
...
Status ClientImpl::multi_hset(const std::string &name,
...
Status ClientImpl::multi_hdel(const std::string &name,
                              const std::vector<std::string> &keys) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::zget(const std::string &name, const std::string &key,
                        int64_t *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::zset(const std::string &name, const std::string &key,
                        int64_t score) {
...
Status ClientImpl::zincr(const std::string &name, const std::string &key,
                         int64_t incrby, int64_t *ret) {
  std::string s_incrby = str(incrby);
  const std::vector<std::string> *resp;
...
Status ClientImpl::zrank(const std::string &name, const std::string &key,
                         int64_t *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::zrrank(const std::string &name, const std::string &key,
                          int64_t *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::zrange(const std::string &name, uint64_t offset,
...
Status ClientImpl::zrrange(const std::string &name, uint64_t offset,
                           uint64_t limit, std::vector<std::string> *ret) {
  std::string s_offset = str(offset);
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
Status ClientImpl::zkeys(const std::string &name, const std::string &key_start,
  ...
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
  resp = this->request("zkeys", name, key_start, s_score_start, s_score_end,
                       s_limit);
  return _read_list(resp, ret);
}
...
Status ClientImpl::zscan(const std::string &name, const std::string &key_start,
  ...
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
  resp = this->request("zscan", name, key_start, s_score_start, s_score_end,
                       s_limit);
  return _read_list(resp, ret);
}
...
Status ClientImpl::zrscan(const std::string &name, const std::string &key_start,
  ...
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
  resp = this->request("zrscan", name, key_start, s_score_start, s_score_end,
                       s_limit);
  return _read_list(resp, ret);
}

Status ClientImpl::multi_zget(const std::string &name,
                              const std::vector<std::string> &keys,
                              std::vector<std::string> *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::multi_zset(const std::string &name,
...
Status ClientImpl::multi_zdel(const std::string &name,
                              const std::vector<std::string> &keys) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::qpush(const std::string &name,
...
Status ClientImpl::qpop(const std::string &name, int64_t limit,
                        std::vector<std::string> *ret) {
  const std::vector<std::string> *resp;
...
Status ClientImpl::qslice(const std::string &name, int64_t begin, int64_t end,
                          std::vector<std::string> *ret) {
...
Status ClientImpl::qrange(const std::string &name, int64_t begin, int64_t limit,
                          std::vector<std::string> *ret) {
  std::string s_begin = str(begin);
  std::string s_limit = str(limit);
  const std::vector<std::string> *resp;
...
#ifdef FASTO
Status ClientImpl::info(const std::string &args,
                        std::vector<std::string> *ret) {
  const std::vector<std::string> *resp;
