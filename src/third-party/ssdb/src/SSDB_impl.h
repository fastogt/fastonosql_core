...
public:
  ...
  request(const std::vector<std::string> &req) override;
  virtual const std::vector<std::string> *
  request(const std::string &cmd) override;
  virtual const std::vector<std::string> *
  request(const std::string &cmd, const std::string &s2) override;
  virtual const std::vector<std::string> *
  ...
  virtual const std::vector<std::string> *
  request(const std::string &cmd, const std::string &s2, const std::string &s3,
          const std::string &s4, const std::string &s5) override;
  virtual const std::vector<std::string> *
  request(const std::string &cmd, const std::string &s2, const std::string &s3,
          const std::string &s4, const std::string &s5,
          const std::string &s6) override;
  virtual const std::vector<std::string> *
  request(const std::string &cmd, const std::vector<std::string> &s2) override;
  virtual const std::vector<std::string> *
  request(const std::string &cmd, const std::string &s2,
  ...
  virtual Status incr(const std::string &key, int64_t incrby,
                      int64_t *ret) override;
  virtual Status keys(const std::string &key_start, const std::string &key_end,
                      uint64_t limit, std::vector<std::string> *ret) override;
  ...
  virtual Status
  multi_set(const std::map<std::string, std::string> &kvs) override;
  ...
  virtual Status hincr(const std::string &name, const std::string &key,
                       int64_t incrby, int64_t *ret) override;
  ...
  virtual Status multi_hget(const std::string &name,
                            ...
                            std::vector<std::string> *ret) override;
  virtual Status
  multi_hset(const std::string &name,
             const std::map<std::string, std::string> &kvs) override;
  ...
  virtual Status multi_zset(const std::string &name,
                            const std::map<std::string, int64_t> &kss) override;
