...
const ConstantCommandsArray g_commands = {
    ...
    CommandHolder(DB_INFO_COMMAND, "[section]",
                  "Return information about the server.", UNDEFINED_SINCE,
    ...
    CommandHolder("SCANSSDB", "<key_start> <key_end> <limit>",
                  "List keys in range (key_start, key_end].", UNDEFINED_SINCE,
    ...
    CommandHolder(DB_FLUSHDB_COMMAND, "-",
                  ...
                  DB_FLUSHDB_COMMAND, 0, 1, CommandInfo::Native,
                  &CommandsApi::FlushDB),
    ...
    CommandHolder(DB_DELETE_KEY_COMMAND, "<key> [key ...]", "Delete key.",
                  ...
                  &CommandsApi::Delete),
    CommandHolder(DB_SET_TTL_COMMAND, "<key> <exptime>",
                  "Set a key's time to live in seconds", UNDEFINED_SINCE,
                  DB_SET_TTL_COMMAND " key 10", 2, 0, CommandInfo::Native,
                  &CommandsApi::SetTTL),
    CommandHolder(DB_GET_TTL_COMMAND, "<key>", "Get the time to live for a key",
                  UNDEFINED_SINCE, DB_GET_TTL_COMMAND " key", 1, 0,
    ...
    CommandHolder("SETX", "<key> <value> <ttl>",
                  "Set the value of the key, with a time to live.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Setx),
    CommandHolder("INCR", "<key> [num]",
    ...
    CommandHolder("RSCAN", "<key_start> <key_end> <limit>",
                  "List keys in range (key_start, key_end].", UNDEFINED_SINCE,
                  UNDEFINED_EXAMPLE_STR, 3, 0, CommandInfo::Native,
                  &CommandsApi::Rscan),
    CommandHolder("MULTI_GET", "<keys> [keys ...]",
                  "Get the values related to the specified "
                  "multiple keys",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0,
                  CommandInfo::Native, &CommandsApi::MultiGet),
    CommandHolder("MULTI_SET", "<key> <value> [key value ...]",
                  "Set multiple key-value pairs(kvs) in "
                  "one method call.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2,
                  INFINITE_COMMAND_ARGS, CommandInfo::Native,
                  &CommandsApi::MultiSet),
    CommandHolder("MULTI_DEL", "<keys> [keys ...]",
                  "Delete specified multiple keys.", UNDEFINED_SINCE,
                  UNDEFINED_EXAMPLE_STR, 1, INFINITE_COMMAND_ARGS,
                  CommandInfo::Native, &CommandsApi::MultiDel),
    CommandHolder("HSET", "<name> <key> <value>",
                  "Set the string value in argument as "
                  "value of the key of a hashmap.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Hset),
    CommandHolder("HGET", "<name> <key>",
                  "Get the value related to the specified "
                  "key of a hashmap",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Hget),
    CommandHolder("HDEL", "<name> <key>", "Delete specified key of a hashmap.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Hdel),
    CommandHolder("HINCR", "<name> <key> <num>",
                  ...
                  "was stored as literal integer.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Hincr),
    CommandHolder("HSIZE", "<name>", "Return the number of pairs of a hashmap.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0,
                  CommandInfo::Native, &CommandsApi::Hsize),
    CommandHolder("HCLEAR", "<name>", "Delete all keys in a hashmap.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0,
                  CommandInfo::Native, &CommandsApi::Hclear),
    ...
    CommandHolder("HRSCAN", "<name> <key_start> <key_end> <limit>",
                  "List key-value pairs of a hashmap with "
                  "keys in range "
                  "(key_start, key_end], in "
                  "reverse order.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 4, 0,
                  CommandInfo::Native, &CommandsApi::Hrscan),
    CommandHolder("MULTI_HGET", "<name> <keys>",
                  "Get the values related to the specified "
                  "multiple keys of a hashmap.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::MultiHget),
    CommandHolder("MULTI_HSET", "<name> <key> <value> [key value ...]",
    ...
    CommandHolder("ZSET", "<name> <key> <score>",
                  "Set the score of the key of a zset.", UNDEFINED_SINCE,
                  UNDEFINED_EXAMPLE_STR, 4, 0, CommandInfo::Native,
                  &CommandsApi::Zset),
    CommandHolder("ZGET", "<name> <key>",
                  "Get the score related to the specified "
                  "key of a zset",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Zget),
    CommandHolder("ZDEL", "<name> <key>", "Delete specified key of a zset.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Zdel),
    CommandHolder("ZINCR", "<name> <key> <num>",
                  ...
                  "was stored as literal integer.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Zincr),
    CommandHolder("ZSIZE", "<name>", "Return the number of pairs of a zset.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0,
                  CommandInfo::Native, &CommandsApi::Zsize),
    CommandHolder("ZCLEAR", "<name>", "Delete all keys in a zset.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0,
                  CommandInfo::Native, &CommandsApi::Zclear),
    CommandHolder("ZRANK", "<name> <key>",
    ...
    CommandHolder("ZRRANK", "<name> <key>",
                  ...
                  "score.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Zrrank),
    CommandHolder("ZRANGE", "<name> <offset> <limit>",
    ...
    CommandHolder("ZRRANGE", "<name> <offset> <limit>",
                  "Returns a range of key-score pairs by "
                  "index range [offset, "
                  "offset + limit). "
                  "Zrrange iterates in reverse order.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Zrrange),
    CommandHolder("ZKEYS",
                  "<name> <key_start> <score_start> "
                  "<score_end> <limit>",
                  "List keys in a zset.", UNDEFINED_SINCE,
                  UNDEFINED_EXAMPLE_STR, 4, 0, CommandInfo::Native,
                  &CommandsApi::Zkeys),
    CommandHolder("ZSCAN",
                  "<name> <key_start> <score_start> "
    ...
    CommandHolder("ZRSCAN",
                  ...
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 5, 0,
                  CommandInfo::Native, &CommandsApi::Zrscan),
    CommandHolder("MULTI_ZGET", "<name> <keys>",
                  "Get the values related to the specified "
                  "multiple keys of a zset.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::MultiZget),
    CommandHolder("MULTI_ZSET", "<name> <key> <score> [key score ...]",
                  "Set multiple key-score pairs(kvs) of a "
                  "zset in one method call.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3,
                  INFINITE_COMMAND_ARGS, CommandInfo::Native,
                  &CommandsApi::MultiZset),
    CommandHolder("MULTI_ZDEL", "<name> <keys>",
                  "Delete specified multiple keys of a zset.", UNDEFINED_SINCE,
                  UNDEFINED_EXAMPLE_STR, 2, 0, CommandInfo::Native,
                  &CommandsApi::MultiZdel),
    CommandHolder("QPUSH", "<name> <item>",
                  "Adds an or more than one element to the "
                  "end of the queue.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Qpush),
    CommandHolder("QPOP", "<name> <size>",
                  "Pop out one or more elements from the "
                  "head of a queue.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0,
                  CommandInfo::Native, &CommandsApi::Qpop),
    CommandHolder("QSLICE", "<name> <begin> <end>",
                  "Returns a portion of elements from the "
                  "queue at the "
                  "specified range [begin, "
                  "end]. begin and end could be negative.",
                  UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0,
                  CommandInfo::Native, &CommandsApi::Qslice),
    CommandHolder("QCLEAR", "<name>", "Clear the queue.", UNDEFINED_SINCE,
...
template <> const char *ConnectionTraits<SSDB>::GetBasedOn() { return "ssdb"; }

template <> const char *ConnectionTraits<SSDB>::GetVersionApi() {
  return "1.9.4";
}
...
namespace {
std::string ConvertToSSDBSlice(const key_t &key) { return key.GetData(); }
} // namespace
namespace internal {
template <>
common::Error
ConnectionAllocatorTraits<ssdb::NativeConnection, ssdb::Config>::Connect(
    const ssdb::Config &config, ssdb::NativeConnection **hout) {
...
template <>
common::Error
ConnectionAllocatorTraits<ssdb::NativeConnection, ssdb::Config>::Disconnect(
...
template <>
bool ConnectionAllocatorTraits<ssdb::NativeConnection, ssdb::Config>::
    IsConnected(ssdb::NativeConnection *handle) {
  if (!handle) {
    return false;
  }
...
namespace ssdb {
namespace {
common::Error AuthContext(::ssdb::Client *context,
...
common::Error CreateConnection(const Config &config,
  ...
  ::ssdb::Client *lcontext =
      ::ssdb::Client::connect(config.host.GetHost(), config.host.GetPort());
  if (!lcontext) {
...
common::Error DBConnection::Info(const std::string &args,
  ...
  err = CheckResultCommand(DB_INFO_COMMAND,
                           connection_.handle_->info(args, &ret));
  if (err) {
    return err;
  }
...
common::Error DBConnection::Setx(const std::string &key,
                                 const std::string &value, ttl_t ttl) {
  ...
  return CheckResultCommand(
      "SETX", connection_.handle_->setx(key, value, static_cast<int>(ttl)));
}
...
common::Error DBConnection::Incr(const std::string &key, int64_t incrby,
  ...
  return CheckResultCommand("INCR",
                            connection_.handle_->incr(key, incrby, ret));
}

common::Error DBConnection::ScanSsdb(const std::string &key_start,
                                     const std::string &key_end, uint64_t limit,
                                     std::vector<std::string> *ret) {
  if (!ret) {
    DNOTREACHED();
    return common::make_error_inval();
  ...
  return CheckResultCommand(
      DB_SCAN_COMMAND,
      connection_.handle_->scan(key_start, key_end, limit, ret));
}
...
common::Error DBConnection::Rscan(const std::string &key_start,
  ...
  return CheckResultCommand(
      "RSCAN", connection_.handle_->rscan(key_start, key_end, limit, ret));
}
...
common::Error DBConnection::MultiGet(const std::vector<std::string> &keys,
  ...
  return CheckResultCommand("MULTIGET",
                            connection_.handle_->multi_get(keys, ret));
}

common::Error
DBConnection::MultiSet(const std::map<std::string, std::string> &kvs) {
  if (kvs.empty()) {
    DNOTREACHED();
    return common::make_error_inval();
  }
...
common::Error DBConnection::Hgetall(const std::string &name,
                                    std::vector<std::string> *ret) {
  if (name.empty() || !ret) {
    DNOTREACHED();
    return common::make_error_inval();
...
common::Error DBConnection::Hdel(const std::string &name,
                                 const std::string &key) {
...
common::Error DBConnection::Hincr(const std::string &name,
                                  const std::string &key, int64_t incrby,
                                  int64_t *ret) {
  ...
  return CheckResultCommand("HINCR",
                            connection_.handle_->hincr(name, key, incrby, ret));
}
...
common::Error DBConnection::Hkeys(const std::string &name,
  ...
  return CheckResultCommand("HKEYS", connection_.handle_->hkeys(
                                         name, key_start, key_end, limit, ret));
}
...
common::Error DBConnection::Hscan(const std::string &name,
  ...
  return CheckResultCommand("HSCAN", connection_.handle_->hscan(
                                         name, key_start, key_end, limit, ret));
}
...
common::Error DBConnection::Hrscan(const std::string &name,
  ...
  return CheckResultCommand(
      "HRSCAN",
      connection_.handle_->hrscan(name, key_start, key_end, limit, ret));
}
...
common::Error DBConnection::MultiHget(const std::string &name,
  ...
  return CheckResultCommand("MULTIHGET",
                            connection_.handle_->multi_hget(name, keys, ret));
}

common::Error
DBConnection::MultiHset(const std::string &name,
  ...
  return CheckResultCommand("MULTIHSET",
                            connection_.handle_->multi_hset(name, keys));
}

common::Error DBConnection::Zget(const std::string &name,
                                 const std::string &key, int64_t *ret) {
  if (name.empty() || key.empty() || !ret) {
    DNOTREACHED();
    return common::make_error_inval();
  }
...
common::Error DBConnection::Zset(const std::string &name,
                                 const std::string &key, int64_t score) {
  if (name.empty() || key.empty()) {
    DNOTREACHED();
    return common::make_error_inval();
  }
  ...
  return CheckResultCommand("ZSET",
                            connection_.handle_->zset(name, key, score));
}

common::Error DBConnection::Zdel(const std::string &name,
                                 const std::string &key) {
  if (name.empty() || key.empty()) {
    DNOTREACHED();
    return common::make_error_inval();
...
common::Error DBConnection::Zincr(const std::string &name,
  ...
  return CheckResultCommand("ZINCR",
                            connection_.handle_->zincr(name, key, incrby, ret));
}
...
common::Error DBConnection::Zrank(const std::string &name,
                                  const std::string &key, int64_t *ret) {
  if (name.empty() || key.empty() || !ret) {
    DNOTREACHED();
    return common::make_error_inval();
  ...
  return CheckResultCommand("ZRANK",
                            connection_.handle_->zrank(name, key, ret));
}

common::Error DBConnection::Zrrank(const std::string &name,
                                   const std::string &key, int64_t *ret) {
  if (name.empty() || key.empty() || !ret) {
    DNOTREACHED();
    return common::make_error_inval();
  ...
  return CheckResultCommand("ZRRANK",
                            connection_.handle_->zrrank(name, key, ret));
}

common::Error DBConnection::Zrange(const std::string &name, uint64_t offset,
                                   uint64_t limit,
                                   std::vector<std::string> *ret) {
  if (name.empty() || !ret) {
    DNOTREACHED();
  ...
  return CheckResultCommand(
      "ZRANGE", connection_.handle_->zrange(name, offset, limit, ret));
}

common::Error DBConnection::Zrrange(const std::string &name, uint64_t offset,
                                    uint64_t limit,
                                    std::vector<std::string> *ret) {
  if (name.empty() || !ret) {
    DNOTREACHED();
  ...
  return CheckResultCommand(
      "ZRRANGE", connection_.handle_->zrrange(name, offset, limit, ret));
}
...
common::Error DBConnection::Zkeys(const std::string &name,
  ...
  return CheckResultCommand(
      "ZKEYS", connection_.handle_->zkeys(name, key_start, score_start,
                                          score_end, limit, ret));
}
...
common::Error DBConnection::Zscan(const std::string &name,
  ...
  return CheckResultCommand(
      "ZSCAN", connection_.handle_->zscan(name, key_start, score_start,
                                          score_end, limit, ret));
}
...
common::Error DBConnection::Zrscan(const std::string &name,
  ...
  return CheckResultCommand(
      "ZRSCAN", connection_.handle_->zrscan(name, key_start, score_start,
                                            score_end, limit, ret));
}
...
common::Error DBConnection::MultiZget(const std::string &name,
  ...
  return CheckResultCommand("MULTIZGET",
                            connection_.handle_->multi_zget(name, keys, ret));
}

common::Error
DBConnection::MultiZset(const std::string &name,
  ...
  return CheckResultCommand("MULTIZSET",
                            connection_.handle_->multi_zset(name, kss));
}
...
common::Error DBConnection::MultiZdel(const std::string &name,
  ...
  return CheckResultCommand("MULTIZDEL",
                            connection_.handle_->multi_zdel(name, keys));
}

common::Error DBConnection::Qpush(const std::string &name,
...
common::Error DBConnection::Qslice(const std::string &name, int64_t begin,
                                   int64_t end, std::vector<std::string> *ret) {
  if (name.empty() || !ret) {
    DNOTREACHED();
    return common::make_error_inval();
  }
  ...
  return CheckResultCommand("QSLICE",
                            connection_.handle_->qslice(name, begin, end, ret));
}
...
common::Error DBConnection::Expire(key_t key, ttl_t ttl) {
  ...
  return CheckResultCommand(
      DB_SET_TTL_COMMAND,
      connection_.handle_->expire(key_slice, static_cast<int>(ttl)));
}
...
common::Error DBConnection::TTL(key_t key, ttl_t *ttl) {
  ...
  int lttl = 0;
  const std::string key_slice = ConvertToSSDBSlice(key);
  err = CheckResultCommand(DB_GET_TTL_COMMAND,
                           connection_.handle_->ttl(key_slice, &lttl));
  if (err) {
    return err;
  }
  *ttl = lttl;
...
common::Error DBConnection::ScanImpl(cursor_t cursor_in,
  ...
  common::Error err = CheckResultCommand(
      DB_SCAN_COMMAND, connection_.handle_->keys(std::string(), std::string(),
                                                 count_keys, &ret));
  if (err) {
    return err;
  }
...
common::Error DBConnection::KeysImpl(const std::string &key_start,
  ...
  return CheckResultCommand(
      DB_KEYS_COMMAND,
      connection_.handle_->keys(key_start, key_end, limit, ret));
}

common::Error DBConnection::DBkcountImpl(size_t *size) {
  std::vector<std::string> ret;
  common::Error err = CheckResultCommand(
      DB_DBKCOUNT_COMMAND, connection_.handle_->keys(
                               std::string(), std::string(), UINT64_MAX, &ret));
  if (err) {
    return err;
  }
...
common::Error DBConnection::FlushDBImpl() {
  ...
  common::Error err = CheckResultCommand(
      DB_FLUSHDB_COMMAND,
      connection_.handle_->keys(std::string(), std::string(), 0, &ret));
  if (err) {
    return err;
  }
