...
ServerInfo::Stats::Stats() : version(0), links(0), total_calls(0), dbsize(0), binlogs() {}

ServerInfo::Stats::Stats(const std::string& common_text) : version(0), links(0), total_calls(0), dbsize(0), binlogs() {
  size_t pos = 0;
  size_t start = 0;
