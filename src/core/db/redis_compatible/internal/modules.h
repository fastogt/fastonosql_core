...
#define REDIS_CL_MODULE "CL"
#define REDIS_CL_MODULE_COMMAND(COMMAND) REDIS_MODULE_COMMAND_GENERATE(REDIS_CL_MODULE, COMMAND)

#define REDIS_TS_MODULE "TS"
#define REDIS_TS_MODULE_COMMAND(COMMAND) REDIS_MODULE_COMMAND_GENERATE(REDIS_TS_MODULE, COMMAND)

namespace fastonosql {
namespace core {
namespace redis_compatible {}  // namespace redis_compatible
}  // namespace core
}  // namespace fastonosql
