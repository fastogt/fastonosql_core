...
std::vector<info_field_t> GetInfoFields() {
  return {std::make_pair(PIKA_SERVER_LABEL, kPikaServerFields),
          ...
          std::make_pair(PIKA_CLIENTS_LABEL, kPikaClientFields),
          std::make_pair(PIKA_HUB_LABEL, kPikaHubFields),
          std::make_pair(PIKA_STATS_LABEL, kPikaStatsFields),
          std::make_pair(PIKA_CPU_LABEL, kPikaCpuFields),
          std::make_pair(PIKA_REPLICATION_LABEL, kPikaReplicationFields),
