...
const ConstantCommandsArray kCommands = {
    ...
    CommandHolder(REDIS_SEARCH_MODULE_COMMAND("ADD"),
    ...
    CommandHolder(REDIS_JSON_MODULE_COMMAND("GET"),
                  ...
                  CommandInfo::Extended,
                  &CommandsApi::JsonGet),
    CommandHolder(REDIS_JSON_MODULE_COMMAND("MGET"),
                  "<key> [key ...] <path>",
