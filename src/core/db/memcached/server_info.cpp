...
const std::vector<Field> kMemcachedCommonFields = {
    Field(MEMCACHED_COMMON_PID_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_UPTIME_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_TIME_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_VERSION_LABEL, common::Value::TYPE_STRING),
    Field(MEMCACHED_COMMON_POINTER_SIZE_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_RUSAGE_USER_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_RUSAGE_SYSTEM_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_CURR_ITEMS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_TOTAL_ITEMS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_BYTES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_CURR_CONNECTIONS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_TOTAL_CONNECTIONS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_CONNECTION_STRUCTURES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_CMD_GET_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_CMD_SET_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_GET_HITS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_GET_MISSES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_EVICTIONS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_BYTES_READ_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_BYTES_WRITTEN_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_LIMIT_MAXBYTES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(MEMCACHED_COMMON_THREADS_LABEL, common::Value::TYPE_UINTEGER32)};
