...
const std::vector<Field> kRedisServerFields = {
    ...
    Field(KEYDB_SERVER_ARCH_BITS_LABEL, common::Value::TYPE_UINTEGER32),
    ...
    Field(KEYDB_SERVER_PROCESS_ID_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_SERVER_RUN_ID_LABEL, common::Value::TYPE_STRING),
    Field(KEYDB_SERVER_TCP_PORT_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_SERVER_UPTIME_IN_SECONDS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_SERVER_UPTIME_IN_DAYS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_SERVER_HZ_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_SERVER_LRU_CLOCK_LABEL, common::Value::TYPE_UINTEGER32),
...
const std::vector<Field> kRedisClientFields = {
    Field(KEYDB_CLIENTS_CONNECTED_CLIENTS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_CLIENTS_CLIENT_LONGEST_OUTPUT_LIST_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_CLIENTS_CLIENT_BIGGEST_INPUT_BUF_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_CLIENTS_BLOCKED_CLIENTS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_CLIENTS_THREAD_0_CLIENTS_LABEL, common::Value::TYPE_UINTEGER32)};

const std::vector<Field> kRedisMemoryFields = {
    Field(KEYDB_MEMORY_USED_MEMORY_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_MEMORY_USED_MEMORY_HUMAN_LABEL, common::Value::TYPE_STRING),
    Field(KEYDB_MEMORY_USED_MEMORY_RSS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_MEMORY_USED_MEMORY_PEAK_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_MEMORY_USED_MEMORY_PEAK_HUMAN_LABEL, common::Value::TYPE_STRING),
    Field(KEYDB_MEMORY_USED_MEMORY_LUA_LABEL, common::Value::TYPE_UINTEGER32),
    ...
    Field(KEYDB_MEMORY_ACTIVE_DEFRAG_RUNNING_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_MEMORY_LAZYFREE_PENDING_OBJECTS_LABEL, common::Value::TYPE_UINTEGER32)};

const std::vector<Field> kRedisPersistenceFields = {
    Field(KEYDB_PERSISTENCE_LOADING_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_RDB_CHANGES_SINCE_LAST_SAVE_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_RDB_DGSAVE_IN_PROGRESS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_RDB_LAST_SAVE_TIME_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_RDB_LAST_DGSAVE_STATUS_LABEL, common::Value::TYPE_STRING),
    Field(KEYDB_PERSISTENCE_RDB_LAST_DGSAVE_TIME_SEC_LABEL, common::Value::TYPE_INTEGER32),
    Field(KEYDB_PERSISTENCE_RDB_CURRENT_DGSAVE_TIME_SEC_LABEL, common::Value::TYPE_INTEGER32),
    Field(KEYDB_PERSISTENCE_AOF_ENABLED_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_AOF_REWRITE_IN_PROGRESS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_AOF_REWRITE_SHEDULED_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_PERSISTENCE_AOF_LAST_REWRITE_TIME_SEC_LABEL, common::Value::TYPE_INTEGER32),
    Field(KEYDB_PERSISTENCE_AOF_CURRENT_REWRITE_TIME_SEC_LABEL, common::Value::TYPE_INTEGER32),
...
const std::vector<Field> kRedisStatsFields = {
    Field(KEYDB_STATS_TOTAL_CONNECTIONS_RECEIVED_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_TOTAL_COMMANDS_PROCESSED_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_INSTANTANEOUS_OPS_PER_SEC_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_REJECTED_CONNECTIONS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_SYNC_FULL_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_SYNC_PARTIAL_OK_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_SYNC_PARTIAL_ERR_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_EXPIRED_KEYS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_EVICTED_KEYS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_KEYSPACE_HITS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_KEYSPACE_MISSES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_PUBSUB_CHANNELS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_PUBSUB_PATTERNS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_LATEST_FORK_USEC_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_MIGRATE_CACHED_SOCKETS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_SLAVE_EXPIRES_TRAKED_KEYS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_ACTIVE_DEFRAG_HITS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_ACTIVE_DEFRAG_MISSES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_ACTIVE_DEFRAG_KEY_HITS_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_STATS_ACTIVE_DEFRAG_KEY_LABEL, common::Value::TYPE_UINTEGER32)};

const std::vector<Field> kRedisReplicationFields = {
    Field(KEYDB_REPLICATION_ROLE_LABEL, common::Value::TYPE_STRING),
    Field(KEYDB_REPLICATION_CONNECTED_SLAVES_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_REPLICATION_MASTER_REPL_OFFSET_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_REPLICATION_BACKLOG_ACTIVE_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_REPLICATION_BACKLOG_SIZE_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_REPLICATION_BACKLOG_FIRST_BYTE_OFFSET_LABEL, common::Value::TYPE_UINTEGER32),
    Field(KEYDB_REPLICATION_BACKLOG_HISTEN_LABEL, common::Value::TYPE_UINTEGER32)};
...
const std::vector<Field> kRedisCpuFields = {Field(KEYDB_CPU_USED_CPU_SYS_LABEL, common::Value::TYPE_DOUBLE),
                                            ...
                                            Field(KEYDB_CPU_SERVER_THREADS_LABEL, common::Value::TYPE_UINTEGER32),
                                            Field(KEYDB_CPU_LONG_LOCK_WAITS_LABEL, common::Value::TYPE_UINTEGER32)};

const std::vector<Field> kRedisClusterFields = {
    Field(KEYDB_CLUSTER_CLUSTER_ENABLED_LABEL, common::Value::TYPE_UINTEGER32)};
