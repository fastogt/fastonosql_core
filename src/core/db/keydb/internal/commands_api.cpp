...
common::Error CommandsApi::Unlink(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  ...
  common::FundamentalValue* val = common::Value::CreateUInteger32Value(keys_deleted.size());
  FastoObject* child = new FastoObject(out, val, red->GetDelimiter());
  out->AddChildren(child);
  return common::Error();
}
...
common::Error CommandsApi::JsonDel(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  ...
  common::FundamentalValue* val = common::Value::CreateInteger64Value(deleted);
...
common::Error CommandsApi::ClThrottle(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  const nkey_t key_str(argv[0]);
  const NKey key(key_str);

  DBConnection::redis_int_t max_burst;
  if (!common::ConvertFromBytes(argv[1], &max_burst)) {
    return common::make_error_inval();
  }

  DBConnection::redis_int_t count_per_period;
  if (!common::ConvertFromBytes(argv[2], &count_per_period)) {
    return common::make_error_inval();
  }
  DBConnection::redis_int_t period;
  if (!common::ConvertFromBytes(argv[3], &period)) {
    return common::make_error_inval();
  }
  DBConnection::redis_int_t quantity = 0;
  if (argv.size() == 5) {
    if (!common::ConvertFromBytes(argv[4], &quantity)) {
      return common::make_error_inval();
    }
  }

  DBConnection* redis = static_cast<DBConnection*>(handler);
  common::ArrayValue* result = nullptr;
  common::Error err = redis->ClThrottle(key, max_burst, count_per_period, period, quantity, &result);
  if (err) {
    return err;
  }

  FastoObject* child = new FastoObject(out, result, redis->GetDelimiter());
  out->AddChildren(child);
  return common::Error();
}

common::Error CommandsApi::TSCreate(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("CREATE"))}, argv),
                         out);
}

common::Error CommandsApi::TSAlter(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("ALTER"))}, argv),
                         out);
}

common::Error CommandsApi::TSAdd(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("ADD"))}, argv), out);
}

common::Error CommandsApi::TSMadd(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("MADD"))}, argv), out);
}

common::Error CommandsApi::TSIncrBy(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("INCRBY"))}, argv),
                         out);
}

common::Error CommandsApi::TSDecrBy(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("DECRBY"))}, argv),
                         out);
}

common::Error CommandsApi::TSCreateRule(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("CREATERULE"))}, argv),
                         out);
}

common::Error CommandsApi::TSDeleteRule(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("DELETERULE"))}, argv),
                         out);
}

common::Error CommandsApi::TSRange(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("RANGE"))}, argv),
                         out);
}

common::Error CommandsApi::TSMrange(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("MRANGE"))}, argv),
                         out);
}

common::Error CommandsApi::TSGet(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("GET"))}, argv), out);
}

common::Error CommandsApi::TSMget(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("MGET"))}, argv), out);
}

common::Error CommandsApi::TSInfo(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("INFO"))}, argv), out);
}

common::Error CommandsApi::TSQueryIndex(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out) {
  DBConnection* red = static_cast<DBConnection*>(handler);
  return red->CommonExec(redis_compatible::ExpandCommand({GEN_CMD_STRING(REDIS_TS_MODULE_COMMAND("QUERYINDEX"))}, argv),
                         out);
}
#endif
