...
struct CommandsApi : public redis_compatible::CommandsApi<DBConnection> {
  ...
  // cl
  static common::Error ClThrottle(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);

  // ts
  static common::Error TSCreate(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSAlter(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSAdd(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSMadd(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSIncrBy(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSDecrBy(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSCreateRule(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSDeleteRule(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSRange(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSMrange(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSGet(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSMget(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSInfo(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
  static common::Error TSQueryIndex(internal::CommandHandler* handler, commands_args_t argv, FastoObject* out);
#endif
};
